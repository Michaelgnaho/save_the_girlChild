        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8">
            {[
              ...
              <a key={item} href={getHref(item)} className="relative group">
          ...
          >
            <div className="w-6 flex flex-col gap-1.5">
              <span
                className={`block h-0.5 w-full bg-gradient-to-r from-orange-400 to-amber-400 transition-all duration-300 ${

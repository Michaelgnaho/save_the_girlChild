			...
			<div className="max-w-6xl mx-auto px-4">
				<div className="flex flex-col md:flex-row justify-between items-center">
					...
					<div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
						<a href="about" className="text-[#e96c08] hover:text-[#fd8a12] transition duration-300">About Us</a>
						<a href="programs" className="text-[#e96c08] hover:text-[#fd8a12] transition duration-300">Donate</a>
						<a href="cta" className="text-[#e96c08] hover:text-[#fd8a12] transition duration-300">Programs</a>
						<a href="contact" className="text-[#e96c08] hover:text-[#fd8a12] transition duration-300">Contact</a>
					</div>
				</div>
				<div className="mt-6 flex justify-center space-x-4">
					...
					<a href="https://www.instagram.com/adunnisaveagirlfoundation/" target="_blank" rel="noopener noreferrer" className="text-[#e96c08] hover:text-[#fd8a12] transition duration-300">

...
function Footer() {
	return (
		<footer className="bg-white-300 shadow-lg border-t-2 text-[#7e3710] py-12" id="footer">
			<div className="max-w-6xl mx-auto px-4">
				<div className="flex flex-col md:flex-row justify-between items-center">
					...
					<div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
						<a href="about" className="text-[#fd8a12] hover:text-[#fea639] transition duration-300 text-lg font-medium">About Us</a>
						<a href="programs" className="text-[#fd8a12] hover:text-[#fea639] transition duration-300 text-lg font-medium">Donate</a>
						<a href="cta" className="text-[#fd8a12] hover:text-[#fea639] transition duration-300 text-lg font-medium">Programs</a>
						<a href="contact" className="text-[#fd8a12] hover:text-[#fea639] transition duration-300 text-lg font-medium">Contact</a>
					</div>
				</div>
				...
				<div className="mt-6 text-center text-sm md:text-base">
					<a href="#" className="text-[#fd8a12] hover:text-[#fea639] transition duration-300">Terms of Use</a> | 
					<a href="#" className="text-[#fd8a12] hover:text-[#fea639] transition duration-300"> Privacy Policy</a>
